...
<body>
  <?php if(!isset($_SESSION['current_doctor']->email)) : ?>
    ...
    <div class="hero">
        <div class="login-box">
            <h1 class="centered">Doctor Log in</h1>
            <p class="centered">Please fill in your credentials to log in</p>
            <form action="<?php echo URLROOT;?>/users/login/doctors" method="post" class="form" id="form" onsubmit="return validateLoginForm()">
            ...
            <div class="form-control">
                ...
                <div class="loginButton flex-button" style="margin-top:60px;">
                  ...
                  <a href="<?php echo URLROOT;?>/users/forgotPassword/doctors">Forgot Password ?</a>
                </div>
            </form>
        </div>
  </div>
